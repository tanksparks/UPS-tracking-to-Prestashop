...
api_key = 'yourownaAPIkey987234fadafed9821734MQ2A'  # Replace with your actual API key
...
# Prompt the user for the day of the month, default to today if no input
day_of_month = input("Enter the day of the month (leave empty for today): ")

# Get the current date
current_date = datetime.now()

# If the user entered a day, modify the current date
if day_of_month.strip():
    try:
...
# File name for the selected day, e.g., "s241016.dbf" for October 16, 2024
